...
- Follow the official GKI steps: [Installation guide](https://kernelsu.org/guide/installation.html).
- Need the boot.img format?
...
- **SUSFS** — [simonpunk](https://gitlab.com/simonpunk/susfs4ksu.git)
...
- [Telegram](https://t.me/TheWildJames) — no DMs; ask in the chat below.
...
- [sidex15](https://github.com/sidex15) — Created the module
